...
theme.ProductForm = function (context, events) {
  ...
  (function price() {
    ...
    events.on("variantchange", function (variant) {
      ...
      if ( variant.compare_at_price > variant.price && variant.available) {
        ...
        element.classList.remove("onsale");
      }
  ...
  (function add_to_cart() {
    ...
    function secondary_styles() {
      element.classList.add("secondary-button");
    }
    document.addEventListener('shopify:payment_button:loaded', secondary_styles);
...
/*============================================================================
  Shifter slide-out on mobile navigation
==============================================================================*/
...
/*============================================================================
  Collection Sidebar Accordion Toggle
==============================================================================*/
